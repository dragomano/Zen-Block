...
$txt['zen_yashare_services']         = 'Отображаемые иконки <div class="smalltext">Через запятую.</div>';
...
$txt['zen_yashare_desc']             = 'Поддерживаемые сервисы: <em>' . $txt['zen_yashare_services_set'] . '</em>';
