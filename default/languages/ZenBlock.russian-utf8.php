...
$txt['zen_ignore_boards'] = 'Игнорируемые разделы';
$txt['zen_ignore_boards_desc'] = 'Перечислите id разделов, в которых Zen Block не должен отображаться.';
$txt['zen_attach_block'] = 'Показывать блок с вложениями';
$txt['zen_img_preview'] = 'Показывать превью для изображений в блоке вложений';
$txt['zen_gplus'] = 'Показывать кнопку Google +1';
